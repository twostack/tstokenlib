...
import '../../lib/src/shielded_pool/header_layout.dart';
import 'definition_test.dart' show buildPP1SpFunnel;

void main() {
  final engine = HeaderLayoutEngine();

  group('HeaderLayoutEngine — PP1_SP equivalence', () {
    late HeaderLayout layout;

    setUp(() {
      layout = engine.compute(buildPP1SpFunnel());
    });
    ...
    test('field count matches PP1_SP (10 fields)', () {
    ...
    test('altstack order matches PP1_SP push order', () {
