...
import '../../lib/src/shielded_pool/definition.dart';

/// Constructs the PP1_SP funnel as a ShieldedPoolDefinition.
ShieldedPoolDefinition buildPP1SpFunnel() {
  return ShieldedPoolDefinition(
    name: 'PP1_SP_Funnel',
...
void main() {
  group('ShieldedPoolDefinition', () {
    test('PP1_SP funnel has correct structure', () {
      final def = buildPP1SpFunnel();

      expect(def.name, 'PP1_SP_Funnel');
    ...
    test('JSON round-trip preserves all fields', () {
      ...
      final restored = ShieldedPoolDefinition.fromJson(decoded);
    ...
    test('JSON round-trip with DataGuardDef and OracleGuardDef', () {
      final def = ShieldedPoolDefinition(
        name: 'test',
        roles: {
      ...
      final restored = ShieldedPoolDefinition.fromJson(jsonDecode(json) as Map<String, dynamic>);
