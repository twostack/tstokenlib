...
/// The proofs and headers of a pool's first two rounds at test parameters,
/// with the real V: round 1 takes in a deposit of 500 through receipt slot
/// 0 beside three padding transfers, and round 2 spends that note into a
/// 200 note and a withdrawal of 300 to [withdrawalPKH]. Nothing here is a
...
class PoolChainFixture {
  ...
  static Future<PoolChainFixture> prove({required List<int> withdrawalPKH}) async {
    final rng = Random(71);
