...
/// Generates the complete PP1_SP (State Machine) locking script.
///
...
class PP1SpScriptGen {
  ...
  ///   3: PP1_SP(state=0x04), 4: PP2, 5: PP3, 6: metadata
  ///
  ...
  static void _emitInductiveProofSettle(ScriptBuilder b) {
    ...
    // Phase 9: Rebuild PP1_SP (state=0x04, no MC update)
  ...
  ///
  /// 6-output layout:
  ///   0: change, 1: operatorRecovery(P2PKH), 2: PP1_SP(state=0x05),
  ...
  static void _emitInductiveProofTimeout(ScriptBuilder b) {
    ...
    // Phase 9: Rebuild PP1_SP (state=0x05, preserve parent's MC and CH)
