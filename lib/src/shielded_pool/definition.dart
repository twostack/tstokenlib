...
///
/// A [ShieldedPoolDefinition] describes an arbitrary state machine in terms of
...
class ShieldedPoolDefinition {
  ...
  factory ShieldedPoolDefinition.fromJson(Map<String, dynamic> json) {
