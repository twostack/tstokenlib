# Shielded Pool Token Template

## pp1_sp.json — Shielded Pool Inductive Proof
...
| Operation | Outputs |
|-----------|---------|
| Standard (create, enroll, confirm, convert) | 5: change, PP1_SP, PP2, PP3, metadata |
| Timeout | 6: change, operatorRecovery(P2PKH), PP1_SP, PP2, PP3, metadata |
| Settle | 7: change, counterpartyShare(P2PKH), operatorShare(P2PKH), PP1_SP, PP2, PP3, metadata |
