...
- **THEN** the encoding is under 100 KB (measured 2026-09-22: 67,428 B, of which 63,512 B proof, 224 B publics, 3,654 B bundle; design record 14.1)
...
- **THEN** it is refused in under 5 ms, before any proof verification starts (measured 2026-09-22: 0.13 ms, `tool/scratch/spend_submission_size.dart`, design record 14.1)
