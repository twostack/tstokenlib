...
The tool SHALL keep a stock of padding transfers, fill it ahead of time on request, and fill a short aggregated round from it, proving any shortfall on the spot; a short round without a supply SHALL be refused.
